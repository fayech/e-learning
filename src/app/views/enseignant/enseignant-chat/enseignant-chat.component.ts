...
@Component({
  selector: 'app-enseignant-chat',
  templateUrl: './enseignant-chat.component.html',
  styleUrls: ['./enseignant-chat.component.scss']
})
export class EnseignantChatComponent implements OnInit {
